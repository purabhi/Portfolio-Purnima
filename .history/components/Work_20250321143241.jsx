...
<a href="https://your-app-link.com" passHref>
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 transition duration-300 cursor-pointer">
        <div className="relative w-full h-48">
          <Image src='work-1.png' width={300} height={300} alt='' className='w-4'/>
        </div>
        <div className="p-4">
          <h2 className="text-xl font-semibold text-gray-800">App Name</h2>
          <p className="text-gray-600 mt-2">
            This is a short description of the app, highlighting its main features.
          </p>
        </div>
      </div>
    </a>
