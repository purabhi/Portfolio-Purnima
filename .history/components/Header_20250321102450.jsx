...
const Header = () => {
  return (
    ...
    className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>
        ...
        <motion.a href='https://github.com/purabhi' className='p-2 border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500'>
                          <Image src={assets.github} alt='Tool' className='w-5 sm:w-7'/>

                          </motion.a>

                          <motion.a href='https://www.linkedin.com/in/purnima-singh-a864941a4/' className='p-2 border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500'>
